        ...
        <div>
            ...
            <section class="text-gray-600 body-font">
                <div class="container px-5 py-16 mx-auto">
                    <div class="flex flex-row text-center justify-between  mb-10 mx-[2%]">
                        <h1 class="sm:text-3xl text-2xl font-semibold title-font mb-4 text-gray-900">All Subjects</h1>
                        <Button className='text-black border border-2 rounded-full px-4 py-2 ' variant="outlined" onClick={handleClickOpen}>
                            Add New Subject
                        </Button>
                    </div>
                    <div className='mx-[2%] glass-panel p-4'>
