...
const SubjAttend = () => {
    ...
    }, [student, subj, location.state?.subCode]);
    ...
    return (
        <div>
            ...
            <div>
                ...
                <div className='container mx-auto '>
                    <div className='flex flex-col justify-center px-6 glass-panel w-[80%] ml-[10%]'>
                ...
                <div className='container mx-auto '>
                    <div className='flex flex-row  justify-center px-6'>
                        ...
                        <div className='flex items-center flex-row glass-panel px-5 py-3'>
                                        ...
                                        <div className="overflow-hidden">
                                            <table className="min-w-full border border-gray-200">
                                                <thead className="bg-gray-100 border-b ">
                                                    <tr className=''>
                                                        <th scope="col" className="text-sm font-semibold text-gray-700 px-6 py-3 text-center">
                                                            Sr
                                                        </th>
                                                        <th scope="col" className="text-sm font-semibold text-gray-700 px-6 py-3 text-center">
                                                            Date
                                                ...
                                                <tbody>
                                                    {
                                                        attendance.map((a) => {
                                                            return <tr key={a.id || a._id || `${a.roll}-${a.date}`} className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-50">
                                                                <td className="px-6 py-3 whitespace-nowrap text-sm font-medium text-gray-900 hover:cursor-pointer text-center">
                                                                    {sn++}
                                                                </td>
                                                                <td className="text-sm text-gray-900 font-medium px-6 py-3 whitespace-nowrap text-center">
                                                                    {(new Date(a.date).toLocaleDateString('en-GB'))}
                                                                </td>
                                                                <td className="text-sm text-gray-900 px-6 py-3 whitespace-nowrap text-center capitalize">
                                                                    {a.status}
                                                                </td>
                                                            </tr>
                                                        })
